normalise_P0A9X9_PF00313_data <- function() {
  ...
  P0A9X9_PF00313_syns$scaled_sigma<-P0A9X9_PF00313_syns$sigma/(syns)
  P0A9X9_PF00313_CX$scaled_sigma<-P0A9X9_PF00313_CX$sigma/(syns)
  P0A9X9_PF00313_CXX$scaled_sigma<-P0A9X9_PF00313_CXX$sigma/(syns)
  P0A9X9_PF00313_CXXX$scaled_sigma<-P0A9X9_PF00313_CXXX$sigma/(syns)
  P0A9X9_PF00313_singleDEL$scaled_sigma<-P0A9X9_PF00313_singleDEL$sigma/(syns)
  P0A9X9_PF00313_doubleDEL$scaled_sigma<-P0A9X9_PF00313_doubleDEL$sigma/(syns)
  P0A9X9_PF00313_tripleDEL$scaled_sigma<-P0A9X9_PF00313_tripleDEL$sigma/(syns)
  P0A9X9_PF00313_Delsub$scaled_sigma<-P0A9X9_PF00313_Delsub$sigma/(syns)
